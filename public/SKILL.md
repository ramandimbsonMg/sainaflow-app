---
name: sainaflow
description: Connect to SainaFlow MCP server to manage CRM data — accounts, contacts, leads, opportunities, targets, products, contracts, activities, documents, target lists, enrichment, email accounts, campaigns, projects, and reports.
---

# SainaFlow MCP Server Skill

Use the SainaFlow MCP server to read and write CRM data. This skill documents all available tools and how to use them.
